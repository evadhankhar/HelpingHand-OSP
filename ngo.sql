...
('ET57fafde00f3cb', 'Help Elders', 'We are organizing an event which will helpful to elders, we distribute some basic required things to the elders. Join the event and give them as per your strength.', '2021-11-03', '10:30:00', 'Vastrapur station road, Vejalpur', 306, '4hr', ''),
('ET57fb039adedd1', 'Save Children', 'We are organizing an event which will helpful to children, we distribute some basic required things to the children like toys, books, food-packets. Join the event and give them as per your strength.', '2021-11-05', '10:00:00', 'Om Shanti School', 341, '6hr', './event_uploads/ET57fb039adedd1.jpg'),
('ET609907e4cb8fe', 'demo', 'demo', '2021-11-10', '15:45:00', 'demo', 395, '2 hours', './event_uploads/ET609907e4cb8fe.JPG');
...
('MG60990839d74bc', 'Bishakha', 'bishakha.sharma2019@vitstudent.ac.in', 'demo', 0);
...
('NS57faf72960274', 'Hospitals are now joining with us.', 'For health case we have a great team of doctors from different hospitals. They are supporting who are not able to pay for medicines. They will provides the free checkups with organizing some camp. now donated medicines or other health care donations will directly given to the hospitals for distributed with poor people.', '2021-11-12', '15:13:00'),
('NS57faf8cc1b41d', 'New join of Children Foundation.', 'more and more foundations are now joining with us \"Hope\" is a new foundation which is now going to connect with us.', '2021-11-09', '14:15:00'),
('NS57faf8f945331', 'Saved Elders.', 'some elder homes where large number of elders who have insufficient facilities as per the requirement, we just full fill them with donor\'s support.', '2021-11-02', '07:18:00'),
('NS57faf937d0c72', 'Childrens are now happy', 'some organizations where number of children living there, they have insufficient children requirement, we just send them toys, clothes and food peckets', '2021-11-05', '12:17:00'),
('NS57faf96480425', 'Women foundations are joining with us.', '\"NaiSoch\" and \"Savera\" which are women organizations is join us and we start distributing donations to them.', '2021-11-07', '12:15:00');
...
('UR6098e418a6c7e', 'Bishakha', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'bishakha.sharma2019@vitstudent.ac.in@vitstudent.ac.in', 'e3addd2b2cb32ec7c555ecdf8a259f46', NULL, NULL, NULL);
